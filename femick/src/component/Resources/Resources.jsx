                ...
                <div className="resources-header">
                    <nav className='resources-navbar'>
                        ...
                        <ul className='link'>
                            ...
                            <a href="#platform" onclick={() => setActiveNav('#home')}  className={activeNav === '#about' ? 'active' : ' '} >Payment</a>
                            <a href="#contact" onclick={() => setActiveNav('#home')}  className={activeNav === '#about' ? 'active' : ' '} >Insurance</a>
                        </ul>
                    </nav>
                </div>
            </div>
