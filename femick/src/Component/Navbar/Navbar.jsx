            ...
            <div className= 'container'>
                <div className="row">
                    ...
                    <ul className= 'navbar'>
                        ...
                        <li><Link to='Portfolio' spy={true}  smooth={true} duration={1000} onClick={showNav}>Skills</Link></li>
                        <li><Link to='Blog' spy={true}  smooth={true} duration={1000} onClick={showNav}>Service</Link></li>
                        <li><Link to='Shop' spy={true}  smooth={true} duration={1000} onClick={showNav}>Project</Link></li>
